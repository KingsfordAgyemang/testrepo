...
input_columns = ['x_sin', 'x_cos', 'y_sin', 'y_cos', 'z_sin', 'z_cos']
vectorAssembler = VectorAssembler(inputCols = input_columns, outputCols = "features" )

from pyspark.ml.classification import GBTClassifier
classifier = classifier = GBTClassifier(
    featuresCol="features",  # The name of the features column
    labelCol="class",        # The name of the label column
